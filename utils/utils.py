...
def load_data(config, label_dict, tokenizer):
    ...
    speech_train = pd.read_pickle(os.path.join(config['data_dir'], "speech_summarized_train_word.pkl"))
    ...
    speech_val = pd.read_pickle(os.path.join(config['data_dir'], "speech_summarized_val_word.pkl"))
    ...
    speech_test = pd.read_pickle(os.path.join(config['data_dir'], "speech_summarized_test_word.pkl"))
